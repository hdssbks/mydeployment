...
import (
	...
	"github.com/hdssbks/mydeployment/internal/controller"
...
func init() {
	...
	utilruntime.Must(kubebuilderv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "426e5e04.zq.com",
	...
	if err = (&controller.MyDeploymentReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("mydeployment-controller"),
